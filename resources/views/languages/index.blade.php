                                ...
                                @foreach ($languages as $language)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('languages.edit', $language) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 mr-3">Edit</a>
                                            @if (auth()->user()->isAdmin() || auth()->user()->hasPermission('delete_language'))
                                                @if (!$language->is_default)
                                                    <form action="{{ route('languages.destroy', $language) }}" method="POST" class="inline delete-form">
                                                        @csrf
                                                        @method('DELETE')
