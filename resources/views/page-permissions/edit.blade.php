    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('page-permissions.update', $pagePermission) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex items-center justify-end">
                            <a href="{{ route('roles.index') }}" class="px-4 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 mr-2">
                                Cancel
                            </a>
